...
(
	...
	CONSTRAINT CH_Marker_Longtitude_Latitude CHECK(Longtitude <= 180 OR Longtitude >= -180 AND Latitude <= 90 OR Latitude >= -90 )
)
GO
...
(
	...
	CONSTRAINT CH_Zone_Longtitude_Latitude CHECK(Longtitude <= 180 OR Longtitude >= -180 AND Latitude <= 90 OR Latitude >= -90 )
)
GO
